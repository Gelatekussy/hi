...
local FlingHighlightColor = Color3.fromRGB(255,50,50) --// First is R, Second is G, Third is B
local GunHatId = 4962455546 -- // (https://www.roblox.com/catalog/5410674378/METAL-x-LIGHTSEER-77)
...
if HighlightFlingBlock ~= false then
    ...
    Highlight.Color3 = (typeof(FlingHighlightColor)=="Color3" and FlingHighlightColor)

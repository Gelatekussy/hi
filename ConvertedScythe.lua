--Chrismas Scythe 
--Converted By Recredile
--Ando#9797
--[[
Hat: https://www.roblox.com/catalog/4492451337/Christmas-Scythe
Net Bypass to run: https://pastebin.com/raw/fXwQRn7f
]]

Bypass = "death"
loadstring(game:GetObjects("rbxassetid://5325226148")[1].Source)()
-----OPTIONS
local ToolName = "Christmas Scythe" ----- the hats name on explorer/dex (not name in catalog)
...
if k == "f" and attack == false and equipped == false then
    ...
    rarmor.Attachment2.Position = Vector3.new(-0.5, 0.1, -0)
    rarmor.Attachment.Rotation = Vector3.new(-0, -0, 120)
	equip()
elseif k == "f" and attack == false and equipped == true then
    ...
    playerss.Torso.WaistBackAttachment.Orientation = Vector3.new(-3.16, -179.28, -125.7)
   unequip()
end
